    ...
    public function fire()
    {
        ...
        if ($this->upload_all) {
            foreach ($this->workers as $worker_file_name) {
                ...
                if ($this->update_queue && $this->need_to_update_queue($iron_worker_name)) {
            ...
            if ($this->update_queue && $this->need_to_update_queue($this->iron_worker_name)) {
